...
public class Event {
	...
	public Event(String icp, Date datum, String kod_po, String druh, long cas,
	...
	public String toString() {
		return "Event [icp=" + icp + ", datum=" + dateFormat.format(datum)
				+ ", kod_po=" + kod_po + ", druh=" + druh + ", cas=" + cas
				+ ", ic_obs=" + ic_obs + ", typ=" + typ + ", datum_zmeny="
				+ dateFormat.format(datum_zmeny) + ", poznamka=" + poznamka
				+ "]";
	}
